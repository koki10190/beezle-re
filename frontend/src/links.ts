...
const klipy_api_key = "IHf7NbJ5SAiVQIVvcN7cHS3WcwJ5ucH8hQsieBN1enK6al5ntRi65mFkya0S8khT";
...
export { github, discord, twitter, youtube, api_uri, tenor_api_key, klipy_api_key, ws_uri, discord_auth_uri, callback_uri, dm_uri, server_uri };
