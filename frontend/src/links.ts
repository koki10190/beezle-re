...
const discord_auth_uri = !production_mode
    ? "https://discord.com/oauth2/authorize?client_id=1394052663494049802&response_type=code&redirect_uri=http%3A%2F%2F10.106.31.90%3A5173%2Fdiscord_auth&scope=identify"
...
export { github, discord, twitter, youtube, api_uri, tenor_api_key, ws_uri, discord_auth_uri };
