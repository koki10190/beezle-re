        ...
        <div className="api-calls-page">
            <header className="api-header">
                ...
                <p>
                    ...
                    that every call requires an <b>Authorization</b> header to be set with an user account. Some types are quite big so I didn't type
                    em out here, check them out{" "}
