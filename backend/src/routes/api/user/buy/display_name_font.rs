...
#[post("/api/user/buy/display_name_font")]
        ...
        _document => {
            ...
            if level < 50 {
                return HttpResponse::Ok().json(
                    doc! {"bought": false, "error": "You need to be level 50 to buy this item!"},
                );
            }
            ...
            mongoose::add_coins(&client, &token_data.handle, -50000).await;
